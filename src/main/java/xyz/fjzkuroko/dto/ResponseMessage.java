...
public class ResponseMessage {
    ...
    public static ResponseMessage newErrorInstance(String msg, Object data) {
        return new ResponseMessage(ResponseMessage.STATUS_ERROR, data, null, msg);
    }
